...
/** Constant that represent if an error occurs during execution of program (during the switches)*/
#define ERROR 0x02

/*! This definition is used to configure or read the IRQS of each Port*/
typedef struct
{
	uint8 flagPortA : 1;	/*!< Definition to PortA */
	uint8 flagPortB : 1;	/*!< Definition to PortB */
	uint8 flagPortC : 1; 	/*!< Definition to PortC */
	uint8 flagPortD : 1;	/*!< Definition to PortD */
	uint8 flagPortE : 1;	/*!< Definition to PortE */
...
/*!
 	 ...
 	 \param[in]  gpio to choose Port (GPIO).
...
/********************************************************************************************/
/*!
 	 \brief	 This function reads the inputs in a specific PORT
 	 \param[in]  portName Port to be configured.
 	 \return value of pins that recieved an input
 */
